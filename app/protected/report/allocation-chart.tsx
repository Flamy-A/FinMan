...
const AllocationChart: React.FC<AllocationChartProps> = ({ financialData }) => {
  ...
  const allocationData: AllocationChartData[] = useMemo(() => {
    ...
    return [
      { name: 'Program Expenses (55%)', value: totalRunningExpense },
      { name: 'Department Development (5%)', value: totalDepartmentDevelopment },
      { name: 'Research Allocation (5%)', value: totalResearchAllocation },
      { name: 'University Income (35%)', value: totalUniversityIncome }
    ];
  }, [financialData]);
